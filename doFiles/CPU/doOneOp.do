...
mem load -i {/SuperScalerProcessor/Assembler/Compiled Files/one operand.txt} -format binary /cpu/insRam/ram
force -freeze sim:/cpu/reset 1 0
force -freeze sim:/cpu/clk 0 0, 1 {50 ps} -r 100
run
force -freeze sim:/cpu/reset 0 0
force -freeze sim:/cpu/inputPort 5 0
run
run
run
run
run
run
force -freeze sim:/cpu/inputPort 0010 0
run
run
run
run
